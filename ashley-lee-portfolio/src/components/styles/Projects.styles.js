...
import { loadIn, projectsToHome, projectsToCase } from "../../animation/keyframes";
...
export const HomeLink = styled.section`
  ...
  ${({ animating }) =>
    ...
    css`
      z-index: 3;
      animation: ${projectsToHome} 0.2s ease-in-out 0s 1;
...
export const LinkWrap = styled.a`
  ...
  ${({ active }) =>
    active &&
    css`
      animation: ${projectsToCase} 0.3s ease-in-out 0.2s 1;
      animation-fill-mode: forwards;
    `}
  position: absolute;
  top: 50%;
