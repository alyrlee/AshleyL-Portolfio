...
import { caseToProjects, disappear, toProjects } from "../animation/keyframes";
...
export const BackButton = styled.div`
  ...
  ${({ toBack }) =>
    ...
    css`
      z-index: 10;
      animation: ${caseToProjects} 0.2s ease-in-out 0s 1;
...
export const NextCase = styled.div`
  ...
  ${({ animating }) =>
    ...
    css`
      z-index: 3;
      animation: ${toProjects} 0.3s ease-in-out 0s 1;
      animation-fill-mode: forwards;
      > p {
        position: relative;
        color: ${theme.colors.red};
